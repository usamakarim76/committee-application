    ...
    return ChangeNotifierProvider(
      ...
      child: Consumer<AdminAccountUpdateViewModel>(
        builder: (BuildContext context, AdminAccountUpdateViewModel model,
                Widget? child) =>
            Scaffold(
              appBar: const AppBarWidget(title: "Update Account",check: true,),
              ...
              child: Column(
                ...
                children: [
                  ...
                  TextFieldWidget(
                    ...
                    function: () {
                      Utils.focusNodeChange(
                          context, model.adminNameNode, model.adminPhoneNode);
                    },
                    onTapFunction: () {},
                  ...
                  TextFieldWidget(
                    ...
                    function: () {
                      Utils.focusNodeChange(context, model.adminAddressNode,
                          model.adminPasswordNode);
                    },
                    onTapFunction: () {},
                    icon: Icons.home,
                  ),
